...
/**
  * Created by zhangyikuo on 2017/5/7.
  */
object AUCValidation {
  /**
    ...
    */
  def predict(data: DataFrame, sModel: CompoundModel, sParams: DataFrame, qParams: DataFrame): DataFrame = {
    ...
    val predictData = sMixData.joinWith(qParams, sMixData("_1.question_id") === qParams("question_id") && sMixData("_1.topic_id") === qParams("topic_id"))
      ...
      val prediction = sModel.subModels.head.predict(sParam.tail ++ qParam, sParam.head)
  ...
  /**
    ...
    */
  def predictWithLabel(data: DataFrame, sModel: CompoundModel, sParams: DataFrame, qParams: DataFrame): RDD[(Double, Double)] = {
  ...
  /**
    ...
    */
  def predictWithoutLabel(data: DataFrame, sModel: CompoundModel, sParams: DataFrame, qParams: DataFrame): RDD[Double] = {
  ...
  /**
    ...
    * @return auc
    */
  def calcAUC(data: DataFrame, sModel: CompoundModel, sParams: DataFrame, qParams: DataFrame): Double = auc(predictWithLabel(data, sModel, sParams, qParams))
